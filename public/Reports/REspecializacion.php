...
switch ($arrayAcademico['mes']) {
  ...
  $y=$pdf->GetY();
  $pdf->setXY(40, $y+8);
  $pdf->MultiCell(130, 8, utf8_decode('CONSTANCIA DE DATOS ESTADÍSTICOS POR 2DA. ESPECIALIZACIÓN'),0,'C',0);
  ...
  $pdf->SetFont('Times', '', 12);
  $pdf->SetX(30);
  $pdf->Cell(50, 8, utf8_decode('2da. Especialiazación en :'),0,0,'L');
  ...
  $pdf->SetFont('Times', '', 12);
  $pdf->SetX(30);
  $pdf->Cell(15, 8, utf8_decode('Sede :'),0,0,'L');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(20, 8, utf8_decode($arrayAcademico['filial']),0,0,'L');
  
  $pdf->SetFont('Times', '', 12);
  $pdf->Cell(95, 8, utf8_decode('Fecha de Aprobación del Titulo de 2da. Esp. por C.U:'),0,0,'R');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(20, 8, utf8_decode($arrayAcademico['FechaAprobacion']),0,1,'R');
  
  $pdf->SetFont('Times', '',12);
  $y=$pdf->GetY();
  $pdf->SetXY(30, $y+6);
  $pdf->MultiCell(150, 8, utf8_decode('Ha cumplido con rellenar su ficha de Estadística, requisito indispensable para la entrega del Título por 2da. Especialización. '),0,'J',0);
