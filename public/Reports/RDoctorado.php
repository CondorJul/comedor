...
switch ($arrayAcademico['mes']) {
  ...
  $y=$pdf->GetY();
  $pdf->setXY(40,$y+5);
  $pdf->MultiCell(130, 8, utf8_decode('CONSTANCIA DE DATOS ESTADÍSTICOS PARA DOCTORES'),0,'C',0);
  ...
  $pdf->SetFont('Times', '', 12);
  $pdf->SetX(30);
  $pdf->Cell(50, 8, utf8_decode('Doctorado en : '),0,0,'L');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(100, 8, utf8_decode($arrayAcademico['nommencion']),0,1,'L');
  
  $pdf->SetFont('Times', '', 12);
  $pdf->SetX(30);
  $pdf->Cell(55, 8, utf8_decode('Año de ingreso al Doctorado : '),0,0,'L');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(20, 8, utf8_decode($arrayAcademico['AnnoIngreso']),0,0,'L');
  
  $pdf->SetFont('Times', '', 12);
  $pdf->Cell(55, 8, utf8_decode('Año de egreso del Doctorado : '),0,0,'R');
  $pdf->SetFont('Times', 'BU', 12);
  ...
  $y=$pdf->GetY();
  $pdf->SetXY(30, $y+6);
  $pdf->MultiCell(150, 8, utf8_decode('Ha cumplido con rellenar su ficha de Estadística, requisito indispensable para la entrega del Diploma de Grado de Doctor.'),0,'J',0);

  $pdf->SetFont('Times', '', 12);
  $y=$pdf->GetY();
  $pdf->setXY(90,$y+15);
  $pdf->Cell(30,20, utf8_decode('Cerro de Pasco, '),0,0,'R');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(10,20, utf8_decode($arrayAcademico['dia']),0,0,'C');
  $pdf->SetFont('Times', '', 12);
  $pdf->Cell(10,20, utf8_decode('de'),0,0,'C');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(20,20, utf8_decode($mes),0,0,'C');
  $pdf->SetFont('Times', '', 12);
  $pdf->Cell(10,20, utf8_decode('del'),0,0,'C');
  $pdf->SetFont('Times', 'BU', 12);
  $pdf->Cell(10,20, utf8_decode($arrayAcademico['anio']),0,1,'L');
