...
<body class="app sidebar-mini rtl sidenav-toggled" style="min-width: 280px;">
  ...
  <main class="app-content" style="background: white;">
    <div class="container">
      <div class="col-md-12">
        <div class="card">
          <h3 class="card-header text-center bg-primary" style="color: #fff; font-weight: bold; font-family: 'arial narrow';">NÚMERO DE COMENSALES POR DIA DE LA SEMANA (TOTAL)<span class="fas fa-chart-bar pull-right"></span></h3>
...
<script>
  ...
  function showGraphic(){
      $.ajax({
        url: 'reporte/get_all_by_day_of_week',
        type: 'POST',
        beforeSend: function(){
        ...
        var data_json_tr=new Array();
        var data_json_ta=new Array();
        //var labels_json=new Array();
          for(var i=0;i<resp.tr.length;i++){
              data_json_tr.push(resp.tr[i].total);
              data_json_ta.push(resp.ta[i].total);
          }
          ...
          var myChart = new Chart(ctx, {
              ...
              data: {
                  ...
                  {
                      label: '# de reservaciones por dia',
                      data: data_json_tr/*[15, 20, 5, 9, 4]*/,
                      backgroundColor: [
                          'rgba(54, 162, 235, 0.2)'
                      ],
                      borderColor: [
                  ...
                  {
                      label: '# de asistencias por dia ',
                      data:   data_json_ta/*[12, 19, 3, 5, 2]*/,
                      backgroundColor: [
                          'rgba(255, 99, 132, 0.2)'
                      ],
                      borderColor: [
