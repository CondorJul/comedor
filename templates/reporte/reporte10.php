...
<body class="app sidebar-mini rtl sidenav-toggled" style="min-width: 280px;">
  ...
  <main class="app-content" style="background: white;">
    <div class="container">
      ...
      <div class="col-md-12">
        <div class="card">
          <h3 class="card-header text-center bg-primary" style="color: #fff; font-weight: bold; font-family: 'arial narrow';">Ranking de Menú<span class="fas fa-chart-bar pull-right"></span></h3>
            ...
            <div>
              <form class="form-horizontal needs-validation" name="form_reporte3" id="form_reporte3" novalidate>
                <div class="row">
                  ...
                  <div class="input-group input-group-sm mb-4 col-lg-3 col-12">
                    <input type="text" class="form-control" id="search" name="search" placeholder="Ingrese un plato" >
      ...
      success: function(resp){
        ...
        $.each(solvet, function(key, value) {
            ...
            $.each(value, function(k, v) {
              ...
              if(k==='type'){
                v=(v===1)?"Desayuno":(v===2)?"Almuerzo":"Cena";
                tr.append(
                $("<td />",{
                  html: v
                })[0].outerHTML
                );
              }else if(k==='prom_ranking'){
                
                var porcentaje=((v*100)/5);
                var color=(v<2)?"bg-danger":(v<3)?"bg-warning":(v<4)?"bg-success":"bg-primary";
                //alert(color);
                //console.log(color);
                v='<div class="progress"><div class="progress-bar progress-bar-striped '+color+'" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width:'+porcentaje+'%">   '+v+' </div> </div>'
