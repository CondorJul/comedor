...
<body class="app sidebar-mini rtl sidenav-toggled" style="min-width: 280px;">
  ...
  <main class="app-content" style="background: white;">
    <div class="container">
      <div class="col-md-12">
        <div class="card">
          <h3 class="card-header text-center bg-primary" style="color: #fff; font-weight: bold; font-family: 'arial narrow';">NÚMERO DE RESERVACIONES POR HORARIO (TOTAL)<span class="fas fa-chart-bar pull-right"></span></h3>
      ...
      $.ajax({
        ...
        var labels_json=new Array();
          for(var i=0;i<resp.length;i++){
              ...
              labels_json.push(resp[i].horary);
          }
